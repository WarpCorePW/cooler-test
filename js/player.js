...
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/css-loader@1.0.1_webpack@4.46.0/node_modules/css-loader??ref--5-1!./node_modules/.pnpm/postcss-loader@3.0.0/node_modules/postcss-loader/src??postcss!./src/playground/vote-frame.css ***!
  \*****************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Renderer.prototype.heading = function heading (text, level, raw) {
  var slug = Object(slugo__WEBPACK_IMPORTED_MODULE_0__["default"])(raw);
...
/* harmony import */ var md__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! md */ "./node_modules/md/dist/md.es.js");
/* harmony import */ var scratch_vm_src_util_xml_escape__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! scratch-vm/src/util/xml-escape */ "./node_modules/scratch-vm/src/util/xml-escape.js");
/* harmony import */ var scratch_vm_src_util_xml_escape__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(scratch_vm_src_util_xml_escape__WEBPACK_IMPORTED_MODULE_6__);
...
const decorate = text => {
  ...
  const isPmLink = /https:\/(\/\w+\.|\/)penguinmod\.(site\/[\s\S]*|site)/g;
  const escaped = scratch_vm_src_util_xml_escape__WEBPACK_IMPORTED_MODULE_6___default()(text);
  const htmlText = Object(md__WEBPACK_IMPORTED_MODULE_5__["default"])(escaped, {
    linksInNewTab: link => isPmLink.test(link)
  });
  // not disabling this just incase, but this is intentional
  const html = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
  ...
  text = react_string_replace__WEBPACK_IMPORTED_MODULE_4___default()(html, linkRegex, (match, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    href: match,
    rel: "noreferrer",
    key: match + i
  }, match));
  ...
  text = react_string_replace__WEBPACK_IMPORTED_MODULE_4___default()(text, /#([\w-]+)/g, (match, i) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    href: "https://studio.penguinmod.site/#".concat(match),
    key: match + i
  }, "#".concat(match)));
...
StudioView.PROJECT_PAGE = 'https://snail-ide.github.io/#$id';
  ...
  class ProjectMetaFetcherComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
    ...
    componentDidUpdate() {
      ...
      fetchProjectMeta(projectId).then(data => {
        ...
        const authorThumbnail = "https://projects.penguinmod.site/api/pmWrapper/scratchUserImage?username=".concat(data.author.username);
...
/* harmony import */ var _components_tw_description_description_jsx__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../components/tw-description/description.jsx */ "./src/components/tw-description/description.jsx");
/* harmony import */ var _containers_webgl_modal_jsx__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../containers/webgl-modal.jsx */ "./src/containers/webgl-modal.jsx");
/* harmony import */ var _components_browser_modal_browser_modal_jsx__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../components/browser-modal/browser-modal.jsx */ "./src/components/browser-modal/browser-modal.jsx");
/* harmony import */ var _components_tw_cloud_variable_badge_cloud_variable_badge_jsx__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../components/tw-cloud-variable-badge/cloud-variable-badge.jsx */ "./src/components/tw-cloud-variable-badge/cloud-variable-badge.jsx");
/* harmony import */ var _lib_tw_environment_support_prober__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../lib/tw-environment-support-prober */ "./src/lib/tw-environment-support-prober.js");
/* harmony import */ var _addons_channels__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../addons/channels */ "./src/addons/channels.js");
/* harmony import */ var _load_service_worker__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./load-service-worker */ "./src/playground/load-service-worker.js");
/* harmony import */ var _addons_entry__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../addons/entry */ "./src/addons/entry.js");
/* harmony import */ var _interface_css__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./interface.css */ "./src/playground/interface.css");
/* harmony import */ var _interface_css__WEBPACK_IMPORTED_MODULE_31___default = /*#__PURE__*/__webpack_require__.n(_interface_css__WEBPACK_IMPORTED_MODULE_31__);
/* harmony import */ var _restore_js__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./restore.js */ "./src/playground/restore.js");
...
if (String(restoring) === "true") {
  console.log(_restore_js__WEBPACK_IMPORTED_MODULE_32__["default"]);
  Object(_restore_js__WEBPACK_IMPORTED_MODULE_32__["default"])(restoreHandler);
}
...
if (_addons_channels__WEBPACK_IMPORTED_MODULE_28__["default"].reloadChannel) {
  _addons_channels__WEBPACK_IMPORTED_MODULE_28__["default"].reloadChannel.addEventListener('message', () => {
    location.reload();
  });
}
if (_addons_channels__WEBPACK_IMPORTED_MODULE_28__["default"].changeChannel) {
  _addons_channels__WEBPACK_IMPORTED_MODULE_28__["default"].changeChannel.addEventListener('message', e => {
    _addons_settings_store_singleton__WEBPACK_IMPORTED_MODULE_16__["default"].setStoreWithVersionCheck(e.data);
  });
}
Object(_addons_entry__WEBPACK_IMPORTED_MODULE_30__["default"])();
...
const getProjectDetailsById = async id => {
  ...
  const response = await fetch("https://projects.penguinmod.site/api/projects/getPublished?id=".concat(id));
...
const Footer = () => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("footer", {
  className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.footer
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
  className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.footerContent
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
  className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.footerText
...
, {
  ...
  className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.footerColumns
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
  className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.footerSection
  ...
  href: "https://snail-ide.github.io/docs/embedding"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
  defaultMessage: "Embedding",
  id: "tw.footer.embed"
})), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
  href: "https://snail-ide.github.io/docs/url-parameters"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
  defaultMessage: "URL Parameters",
  id: "tw.footer.parameters"
})), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
  href: "https://snail-ide.github.io/docs/"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
  ...
  href: "https://snail-ide.github.io/examples/"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
  ...
  href: "https://snail-ide-beta.mobirisesite.com/"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.isLoading && !this.props.isLoading) {
      Object(_load_service_worker__WEBPACK_IMPORTED_MODULE_29__["loadServiceWorker"])();
    }
  }
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: classnames__WEBPACK_IMPORTED_MODULE_0___default()(_interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.container, {
        [_interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.playerOnly]: isHomepage,
        [_interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.editor]: isEditor
      })
    }, isHomepage ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.menu
      ...
      className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.center,
      style: isPlayerOnly ? {
    ...
    }, props)), isHomepage ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, window.LastFetchedProject != null && window.LastFetchedProject.accepted == false ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.remixWarningBox
      ...
      className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.unsharedUpdate
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "row"
      ...
      target: "_blank",
      href: "https://penguinmod.site/profile?user=" + ((_projectDetailCache$S = projectDetailCache[String(window.LastFetchedProject.remix)]) === null || _projectDetailCache$S === void 0 ? void 0 : _projectDetailCache$S.owner)
      ...
      src: "https://projects.penguinmod.site/api/pmWrapper/scratchUserImage?username=" + ((_projectDetailCache$S4 = projectDetailCache[String(window.LastFetchedProject.remix)]) === null || _projectDetailCache$S4 === void 0 ? void 0 : _projectDetailCache$S4.owner)
      ...
      target: "_blank",
      href: "https://penguinmod.site/profile?user=" + ((_projectDetailCache$S5 = projectDetailCache[String(window.LastFetchedProject.remix)]) === null || _projectDetailCache$S5 === void 0 ? void 0 : _projectDetailCache$S5.owner)
    ...
    }, getProjectDetailsById(window.LastFetchedProject.remix).yesIDefinetlyKnowHowToUseReactProperlyShutUp)) : null, Object(_lib_tw_environment_support_prober__WEBPACK_IMPORTED_MODULE_27__["isRendererSupported"])() ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_containers_webgl_modal_jsx__WEBPACK_IMPORTED_MODULE_24__["default"], {
      isRtl: isRtl
    }), Object(_lib_tw_environment_support_prober__WEBPACK_IMPORTED_MODULE_27__["isBrowserSupported"])() ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_browser_modal_browser_modal_jsx__WEBPACK_IMPORTED_MODULE_25__["default"], {
      isRtl: isRtl
    }), hasCloudVariables && projectId !== '0' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.section
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_tw_cloud_variable_badge_cloud_variable_badge_jsx__WEBPACK_IMPORTED_MODULE_26__["default"], null)), description.instructions || description.credits ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.section
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_tw_description_description_jsx__WEBPACK_IMPORTED_MODULE_23__["default"], {
      ...
      className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.remixList
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("a", {
        ...
        className: _interface_css__WEBPACK_IMPORTED_MODULE_31___default.a.remixProject
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("img", {
        style: {
          height: "72px"
        },
      ...
      target: "_blank",
      href: "https://penguinmod.site/profile?user=" + window.LastFetchedProject.owner
...
var content = __webpack_require__(/*! !../../node_modules/.pnpm/css-loader@1.0.1_webpack@4.46.0/node_modules/css-loader??ref--5-1!../../node_modules/.pnpm/postcss-loader@3.0.0/node_modules/postcss-loader/src??postcss!./vote-frame.css */ "./node_modules/.pnpm/css-loader@1.0.1_webpack@4.46.0/node_modules/css-loader/index.js?!./node_modules/.pnpm/postcss-loader@3.0.0/node_modules/postcss-loader/src/index.js?!./src/playground/vote-frame.css");
...
const VoteFrame = props => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("iframe", {
  ...
  src: "https://penguinmod.site/embed/vote?id=".concat(props.id, "#dark=").concat(props.darkmode)
});
